 ...
 * process.
 */
public class KsmAuthenticationException extends RuntimeException {
     ...
     */
    public KsmAuthenticationException(String message) {
        super(message);
    }
     ...
     */
   public KsmAuthenticationException(String message, Throwable cause) {
        super(message, cause);
    }
